...
const MessageInput = () => {
    ...
    const handleSendMessage = async (e)=>{
        e.preventDefault(); //dosent refresh the page
    ...
    <div className='p-4 w-full'>
       ...
       <form onSubmit={handleSendMessage} className='flex items-center gap-2'>
        <div className='flex flex-1 gap-2'>
          ...
          <button type='submit' className='btn btn-sm btn-circle justify-center items-center' disabled={!text.trim() && !imagePreview}>
            <Send size={22}/>
          </button>
       </form>
    </div>
